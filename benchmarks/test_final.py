...
def benchmark_compression():
    ...
    print(f"Without compression:  {sum(times)/len(times):6.2f}ms  |  {len(result):,} bytes")
    ...
    for _ in range(10):
        ...
        times.append((time.perf_counter() - start) * 1000)
    print(f"With compression:     {sum(times)/len(times):6.2f}ms  |  {len(result):,} bytes")
    ...
    for _ in range(5):
        ...
        times.append((time.perf_counter() - start) * 1000)
    print(f"Without compression:  {sum(times)/len(times):7.2f}ms  |  {len(result):,} bytes")
    ...
    for _ in range(5):
        ...
        times.append((time.perf_counter() - start) * 1000)
    print(f"With compression:     {sum(times)/len(times):7.2f}ms  |  {len(result):,} bytes")
